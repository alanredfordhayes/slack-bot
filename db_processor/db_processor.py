...
def lambda_handler(event, context):
    ...
    for record in event['Records']:
        ...
        logging.info('event_api_record_item_type', event_api_record_item_type)
        event_api_record_item_keys = event_api_record.keys()
        logging.info('event_api_record_item_keys', event_api_record_item_keys)
